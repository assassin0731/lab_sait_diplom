		...
		<a align="center" style="font-size:18px;line-height:2.5; color:#909090; position:relative;left:1%; bottom:8px"> / </a>
			...
			<a align="center" style="font-size:18px;line-height:2.5; color:#909090; position:relative;left:1%; bottom:8px"> / </a>
				...
				<a align="center" style="font-size:18px;line-height:2.5; color:#909090; position:relative;left:1%; bottom:8px"> / </a>
					...
					<a align="center" style="font-size:18px;line-height:2.5; color:#909090; position:relative;left:1%; bottom:8px"> / </a>
						<a align="center" style="font-size:18px;line-height:2.5; color:#4E4E4E; position:relative;left:1%; bottom: 8px;">Образцы</a>
	</div>

  <div id="banner5" style=" height: 465px; width: 1235px; ">
		<div id="banner9" style=" height: 63px; width: 1235px; ">
	<br>
	<b>Выбор образцов для проведения испытаний</b>
		</div>
...
if($selected=='Pudge')
{
		...
		<form action="/zakaz/zayavka/otbor/obrazez/submit" method="post">
			@csrf
			<?php $zayav = Session::get('zayav');
			if (!$zayav->id_otbor) {$fornew=$zayav->id;}
			else  {$fornew=$zayav->id_otbor;}
			session(['key' => $fornew]);
			$value = session('key');
			?>
		...
		<div class="form-group row">
				<label for="name" class="col-md-4 col-form-label text-md-right" style="position:absolute; left:8.6%; top:85px; font-weight: bold;">{{ __('Наименование продукции:') }}</label>

				<div class="col-md-6" style="position:absolute; left: 8.6%; top:106px; width:725px;">
	  ...
	  <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" autocomplete="name" autofocus>
		...
		<div class="form-group row">
				<label for="date" class="col-md-4 col-form-label text-md-right" style="position:absolute; left:8.6%; top:185px; font-weight: bold;">{{ __('Дата изготовления:') }}</label>

		 <div class="col-md-6" style="position:absolute; left: 8.6%; top:206px;">
 ...
 <input id="data" type="date" class="form-control @error('data') is-invalid @enderror" name="data" autocomplete="data"  style="font-size:15px; width:250px;">
		...
		<div class="form-group row">
				<label for="vid" class="col-md-4 col-form-label text-md-right" style="position:absolute; left:8.6%; top:285px; font-weight: bold;">{{ __('Вид упаковки, размер партии:') }}</label>
		 <div class="col-md-6" style="position:absolute; left: 8.6%; top:306px; width:725px;">
 <input id="vid" type="text" class="form-control @error('act') is-invalid @enderror" name="vid" autocomplete="vid" autofocus>
		...
		<div  class="form-group row mb-0" style="position:absolute; left:25.3%; top:383px; color: #FFF !important;">
				<div  class="col-md-6 offset-md-4" >
	...
	<div class="form-group row mb-0" style="position:absolute; top:383px; left:47.3%;  ">
			<form action='/zakaz/zayavka/otbor/obrazez/submit1' method='post'>
				@csrf
			<input name='id_zayav' id='id_zayav' autocomplete='id_zayav' value='{{$fornew}}' hidden>
<div  class="col-md-6 offset-md-4" >
		<button type="submit" id="buttonenter1" class="buttonenter1">
				{{ __('Завершить добавление образцов') }}
		</button>
	</form>
</div>
	</div>
