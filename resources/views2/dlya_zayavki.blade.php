...
<b>Общие данные для составления заявки</b>
		...
		<form action="/profile/dlya_zayavki/submit" method="post">
			@csrf
		<div class="form-group row">
		 ...
		 <div class="col-md-6" style="position:absolute; left: 8.6%; top:110px;width: 1020px;">
						...
						<input id="adr" type="text" class="form-control @error('adr') is-invalid @enderror" name="adr" value="{{ old('adr') }}" autocomplete="adr" autofocus placeholder="Индекс, город, улица, дом, № офиса/квартиры">
	 ...
	 $(function() {
		 $('.inn').mask('000000000000');
						...
						<input id="inn" type="text" class="inn" name="inn" value="{{ old('inn') }}" autocomplete="inn" autofocus placeholder="Необходимо указать 12 цифр" minlength="12">
	 ...
	 $(function() {
		 $('.ogrn').mask('000000000000000');
						...
						<input id="ogrn" type="text" class="ogrn" name="ogrn" value="{{ old('ogrn') }}" autocomplete="ogrn" autofocus placeholder="Необходимо указать 15 цифр" minlength="15">
