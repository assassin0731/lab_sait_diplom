...
<a href="#" align="center" style="font-size:18px;line-height:2.5; color:#4E4E4E; position:relative;left:1%; bottom: 8px;">Главная</a>
		<a align="center" style="font-size:18px;line-height:2.5; color:#909090; position:relative;left:1%; bottom:8px"> / </a>
			...
			<a align="center" style="font-size:18px;line-height:2.5; color:#909090; position:relative;left:1%; bottom:8px"> / </a>
				...
				<a align="center" style="font-size:18px;line-height:2.5; color:#909090; position:relative;left:1%; bottom:8px"> / </a>
					<a align="center" style="font-size:18px;line-height:2.5; color:#4E4E4E; position:relative;left:1%; bottom: 8px;">Завершение</a>
  ...
  <div id="banner5" style=" height: 528px; width: 1235px; ">
	...
	<br>
	<b>Завершение подачи заявки</b>
		</div>
		<div id="poslereg" style="left:100px">
			<div style="font-weight:bold; font-size:20px; ">
				Поздравляем!
			</div>
			Заявка успешно отправлена. Вы можете отслеживать статус поданной заявки в личном кабинете.
		</div></br>
...
<input name="id_zayav" id="id_zayav" autocomplete="id_zayav" value="{{$fornew}}" hidden>
		...
		<div  class="form-group row mb-0" style="position:absolute; left:17%; top:184px; color: #FFF !important;">
				<div  class="col-md-6 offset-md-4" >
