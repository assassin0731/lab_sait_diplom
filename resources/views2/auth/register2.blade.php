                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right" style="position:absolute; left:20%; top:57px; font-weight: bold;">{{ __('ФИО:') }}</label>

                            <div class="col-md-6" style="position:absolute; left: 25.5%; top:36px;width: 600px;">
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-md-4 col-form-label text-md-right" style="position:absolute; left:19.5%; top:137px;font-weight: 1000;">{{ __('E-Mail:') }}</label>

                            <div class="col-md-6" style="position:absolute; left:25.5%; top:116px; width: 600px;">
                        ...
                        <div class="form-group row">
                            <label for="password" class="col-md-4 col-form-label text-md-right" style="position:absolute; left:18.2%; top:217px;font-weight: bold;">{{ __('Пароль:') }}</label>

                            <div class="col-md-6" style="position:absolute; left:25.5%; top:196px; width: 600px;">
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-right" style="position:absolute; left:8%; top:297px;font-weight: bold;">{{ __('Подтверждение пароля:') }}</label>

                            <div class="col-md-6" style="position:absolute; left:25.5%; top:276px; width: 600px;">
                                <input id="password-confirm" type="password" class="form-control" name="password_confirmation" required autocomplete="new-password">
                            </div>
                        </div>

                        <div  class="form-group row mb-0" style="position:absolute; left:44.4%; top:360px; color: #FFF !important;">
